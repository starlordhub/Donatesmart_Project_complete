...
function Login() {
    ...
    return (
        <div className="min-h-screen bg-dark-900 flex items-center justify-center px-6 relative overflow-hidden">
            ...
            <div className="absolute w-[500px] h-[500px] bg-brand rounded-full blur-[120px] mix-blend-screen opacity-[0.04] -bottom-[150px] -right-[150px] pointer-events-none" />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <Card padding="p-8">
                    {error && (
                        <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-3.5 mb-5 text-sm text-red-400">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="flex items-center gap-3 my-6">
                        ...
                        <span className="text-[10px] text-neutral-600 uppercase tracking-wider">or continue with</span>
                        <div className="flex-1 h-px bg-white/[0.05]" />
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 h-11 rounded-xl border border-white/[0.08] bg-white/[0.02] text-sm text-neutral-400 hover:bg-white/[0.05] hover:border-white/[0.15] transition-all cursor-pointer">
                    ...
                    <p className="text-center text-xs text-neutral-500 mt-6">
                        Don't have an account? <Link to="/register" className="text-brand font-medium hover:underline">Create one</Link>
                    </p>
                </Card>
            </div>
        </div>
